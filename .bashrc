...
if command -v eza >/dev/null 2>&1; then
    ...
    alias ls='exa -al --long --header --icons --group-directories-first'
fi
...
alias r="ranger"
# alias's for ls
#alias ls="exa -lahm --color always --group-directories-first"
#alias tree="exa --tree"

# fzf with preview
alias pfl="fzf --preview='less {}' --bind shift-up:preview-page-up,shift-down:preview-page-down"
alias pfb="fzf --preview 'bat --style,changes --color=always {} | head -500'"
# add zoxide to shell
